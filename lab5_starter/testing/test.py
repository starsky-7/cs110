...
tests = [
  ("Exercise 3 (Practice with Advanced features) test", "student_output/ex3_test.out",TestCase(os.path.join(file_locations,'circ_files/ex3_test.circ'), os.path.join
(file_locations,'reference_output/ex3_test.out'), "")),
  ("Exercise 4 (Rotate Right) test", "student_output/ex4_test.out",TestCase(os.path.join(file_locations,'circ_files/ex4_test.circ'), os.path.join
(file_locations,'reference_output/ex4_test.out'), "")),
  ("Exercise 5 (Runing LED) test", "student_output/ex5_test.out",TestCase(os.path.join(file_locations,'circ_files/ex5_test.circ'), os.path.join
