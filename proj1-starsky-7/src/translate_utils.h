...
typedef enum {
  ...
  IMM_5_UNSIGNED, /* 5-bit unsigned number, used in slli, srli, srai and other instructions */
  IMM_13_SIGNED, /* 13-bit signed number, used in beq, bne and other branch instructions */
  IMM_21_SIGNED, /* 21-bit signed number, used in jal instruction */
  IMM_20_UNSIGNED, /* 20-bit unsigned number, used in U-type instructions */
